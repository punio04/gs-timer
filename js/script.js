...
function CDT() {
  const text = '無料セミナーの募集終了まで<br>';
  const tl = new Date('2022/11/24 23:59:00');
  const timer = new CountdownTimer('CDT', tl, '<span class="text-sp">無料セミナーの募集終了しました</span>');
  timer.countDown();
...
function CDT2() {
  const text = '無料セミナーの募集終了まで<br>';
  const tl = new Date('2022/11/24 23:59:00');
  const timer = new CountdownTimer('CDT2', tl, '<span class="text-sp">無料セミナーの募集終了しました</span>');
  timer.countDown();
...
function CDT3() {
  const text = '無料セミナーの募集終了まで<br>';
  const tl = new Date('2022/11/24 23:59:00');
  const timer = new CountdownTimer('CDT3', tl, '<span class="text-sp">無料セミナーの募集終了しました</span>');
  timer.countDown();
...
function CDT4() {
  const text = '無料セミナーの募集終了まで<br>';
  const tl = new Date('2022/11/24 23:59:00');
  const timer = new CountdownTimer('CDT4', tl, '<span class="text-sp">無料セミナーの募集終了しました</span>');
  timer.countDown();
...
function CDT5() {
  const text = '無料セミナーの募集終了まで<br>';
  const tl = new Date('2022/11/24 23:59:00');
  const timer = new CountdownTimer('CDT5', tl, '<span class="text-sp">無料セミナーの募集終了しました</span>');
  timer.countDown();
...
function CDT6() {
  const text = '無料セミナーの募集終了まで<br>';
  const tl = new Date('2022/11/24 23:59:00');
  const timer = new CountdownTimer('CDT6', tl, '<span class="text-sp">無料セミナーの募集終了しました</span>');
  timer.countDown();
...
function CDT7() {
  const text = '無料セミナーの募集終了まで<br>';
  const tl = new Date('2022/11/24 23:59:00');
  const timer = new CountdownTimer('CDT7', tl, '<span class="text-sp">無料セミナーの募集終了しました</span>');
  timer.countDown();
